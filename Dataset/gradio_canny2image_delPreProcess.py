...
# 加载自训练模型
# model.load_state_dict(load_state_dict('./models/control_sd15_fill50k.ckpt', location='cuda'))
# model.load_state_dict(load_state_dict('./models/control_sd15_danbooru_epoch9.ckpt', location='cuda'))
model = model.cuda()
